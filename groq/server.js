...
app.post('/createGirlfriend', async (req, res) => {
    const { userName, girlfriendName, girlfriendPersonality, girlfriendInterests, conversationHistory, girlfriendLanguage } = req.body;
    ...
    try {
        const response = await actLikeGirlfriend(userName, girlfriendName, girlfriendPersonality, girlfriendInterests, girlfriendLanguage, messages);
        res.json(response);
    } catch (error) {
